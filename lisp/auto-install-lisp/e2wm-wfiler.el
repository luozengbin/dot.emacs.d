...
(defvar e2wm:dp-wfiler-minor-mode-map 
  (e2wm:define-keymap
   '(("C-f" . e2wm:dp-wfiler-move-buffers-command)
     ("C-b" . e2wm:dp-wfiler-move-buffers-command)
     ("P" . e2wm:dp-wfiler-sync-buffers-command)
     ("S" . e2wm:dp-wfiler-sub-toggle-command))
   e2wm:prefix-key))
