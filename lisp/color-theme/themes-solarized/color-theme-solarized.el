...
(defun color-theme-solarized-dark ()
  ...
  ;; part of mode line face
  (set-face-bold-p  'which-func t)
  ;;(set-face-foreground  'which-func "#93a1a1")
  (set-face-foreground  'which-func "#81908f")
...
(defun color-theme-solarized-light ()
  ...
  ;;(set-face-foreground  'region "LightSteelBlue1")
  (set-face-bold-p  'which-func t)
  (set-face-foreground 'which-func "#465a61")
  (put 'which-func 'init-flag t)
)
